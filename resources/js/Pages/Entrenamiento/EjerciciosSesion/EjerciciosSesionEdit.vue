...
const form = useForm({
    ejercicio_id: props.ejerciciosSesion.ejercicio_id,
    series: props.ejerciciosSesion.series,
    repeticiones: props.ejerciciosSesion.repeticiones,
    peso: props.ejerciciosSesion.peso,
    descanso_segundos: props.ejerciciosSesion.descanso_segundos,
    orden: props.ejerciciosSesion.orden,
});
...
const handleSubmit = () => {
    form.put(route('ejercicios-sesion.update', [props.plan.id, props.sesion.id, props.ejerciciosSesion.id]), {
        onFinish: () => {
            // El redirecto al índice lo maneja el servidor
        }
    });
};
...
<template>
    <AppLayout title="Editar Ejercicio de Sesión">
        <div class="-m-8 min-h-full p-8">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <h2 class="text-4xl font-display text-white">Editar Ejercicio · Semana {{ props.sesion.numero_semana
                    ...
                    <div v-if="selectedExercise" class="rounded-lg border border-slate-700 bg-slate-800/60 p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                            ...
                            <div>
                                ...
                                <p class="text-white font-medium">{{ selectedExercise.muscle_group?.nombre || 'Si grupo' }}</p>
                            </div>
                            <div>
